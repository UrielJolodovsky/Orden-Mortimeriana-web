    ...
    return(
        <div id="contacto" className="w-full flex justify-center items-center bg-black">
            <div className="flex flex-col justify-center items-center text-white pt-5">
                ...
                <p className="text-center pb-5">Si tienes alguna duda o sugerencia, no dudes en contactarnos a nuestro correo electrónico:</p>
                <p className="text-center pb-5 hover:scale-105">cuarentenaoma@gmail.com</p> 
